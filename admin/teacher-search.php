...
<body style="padding-top: 56px;"> 
    ...
    <div class="container mt-5">
        ...
        <form  method="get" action="teacher-search.php" class="mt-3">
         ...
         <thead>
           ...
           <td>
            ...
            foreach($classes as $class_id){
                $class = getAllClassById($class_id, $conn);
                $c_temp = getAllGradeById($class['grade'], $conn);
                $section = getAllSectionById($class['section'], $conn);
