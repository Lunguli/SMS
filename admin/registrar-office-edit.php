...
isset($_GET['r_user_id'])){
    ...
    if($_SESSION['role'] == 'Admin'){
        ...
        $r_user = getAllR_usersById($r_user_id, $conn);
...
<body style="padding-top: 56px;"> 
    ...
    <div class="container mt-5">
        ...
        <hr> <h3>Edit Registrar Office User</h3> <hr>
...
<form method="post" class="shadow p-3 my-5 form-w" id = "change_password" action="req/registrar-office-change.php">
