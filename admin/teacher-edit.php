...
isset($_GET['teacher_id'])){
    ...
    if($_SESSION['role'] == 'Admin'){
        ...
        $teacher = getAllTeacherById($teacher_id, $conn);
...
<body style="padding-top: 56px;"> 
    ...
    <div class="container mt-5">
      ...
      <div class="mb-3">
        ...
        name="teacher_id" hidden>
    
         <div class="mb-3">
          <label class="form-label">Subject</label>
          <div class="row row-cols-5">
          <!-- check the boxes for the subjects when editing it -->
          <?php 
         ...
         <div class="mb-3">
          ...
          <div class="row row-cols-5">
            ...
            <!-- check the boxes for the grades when editing it -->
          <?php 
            ...
            foreach ($classes  as $class){ 
               ...
               $grade = getAllGradeById($class['class_id'], $conn);
            ?>
...
<form method="post" class="shadow p-3 my-5 form-w" id = "change_password" action="req/teacher-change.php">
  ...
  <button type="submit" class="btn btn-primary">Change</button>
    ...
    <script>
        $(document).ready(function(){
         ...
         // generate random String or Character
