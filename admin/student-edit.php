...
<body style="padding-top: 56px;"> 
  ...
  <div class="mb-3">
          ...
          <input type="file" class="form-control"value="<?=$student['photo']?>" name="Photo">
  </div>
  ...
  <div class="mb-3">
          ...
          <div class="row row-cols-5">
            ...
            <!-- check the boxes for the Section when editing it -->
          <?php 
...
<form method="post" class="shadow p-3 my-5 form-w" id = "change_password" action="req/student-change.php">
